            ...
            <li>
              <Link className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M19.5 20.25h-15A2.25 2.25 0 012.25 18V6A2.25 2.25 0 014.5 3.75h15A2.25 2.25 0 0121.75 6v12a2.25 2.25 0 01-2.25 2.25zM4.5 5.25A.75.75 0 003.75 6v12a.75.75 0 00.75.75h15a.75.75 0 00.75-.75V6a.75.75 0 00-.75-.75h-15z" />
                  <path d="M7.5 8.25h9a.75.75 0 000-1.5h-9a.75.75 0 000 1.5zM7.5 12h9a.75.75 0 000-1.5h-9a.75.75 0 000 1.5zM7.5 15.75h9a.75.75 0 000-1.5h-9a.75.75 0 000 1.5z" />
                </svg>
