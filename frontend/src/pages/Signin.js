            ...
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
              ...
              >
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  className="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 dark:border-gray-600 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none dark:bg-gray-800 dark:text-white"
                  data-rounded="rounded-lg"
                  data-primary="blue-500"
                ...
                <p className="w-full mt-4 text-sm text-center text-gray-500 dark:text-gray-400">
                  ...
                  <Link to="/signup" className="text-blue-500 dark:text-blue-400 underline">
                    Sign up here
                  </Link>
                </p>
              </div>
