              ...
              <div className="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                ...
                <div className="relative w-full mt-10 space-y-8">
                  ...
                  <div className="relative">
                    ...
                    <button className="inline-block w-full px-5 py-4 mt-3 text-lg font-bold text-center text-gray-900 transition duration-200 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 ease">
                      Sign up with Google
                    </button>
                  </div>
                </div>
